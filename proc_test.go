...
var ArgTests = []ArgTest{
	...
	},
	{
		...
		script:      `proc test {args -args} {list::sort [var]}; test`,
		expectedErr: nil,
		expectedOut: `{args {}}`,
	},
	{
		desc:        `with {-args args}, anything goes`,
		script:      `proc test {args -args} {list::sort [var]}; test 1 2 3`,
		expectedErr: nil,
		expectedOut: `{args {1 2 3}}`,
	},
	{
		desc:        `with {-args args}, anything goes`,
		script:      `proc test {args -args} {list::sort [var]}; test -1 a -2 b -3 c`,
		expectedErr: nil,
		expectedOut: `{1 a} {2 b} {3 c} {args {}}`,
	},
	{
		desc:        `with {-args args}, anything goes`,
		script:      `proc test {args -args} {list::sort [var]}; test -1 a -2 b -3 c one two three`,
		expectedErr: nil,
	...
	},
	{
		...
		script:      `proc test {-args -required} {list::sort [var]}; test -1 a -2 b -3 c -required {totes ok}`,
		expectedErr: nil,
		expectedOut: "{1 a} {2 b} {3 c} {required {totes ok}}",
	},
	{
		desc:        `with {-args -required}, any named arg is okay, but we need -required`,
		script:      `proc test {-args -required} {list::sort [var]}; test -1 a -2 b -3 c`,
